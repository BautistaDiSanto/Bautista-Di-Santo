  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex justify-center gap-4">
        ...
        <a
          href="#projects"
          className="px-6 py-3 border-gray-600 rounded-lg hover:bg-gray-800 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200"
        >
          View Projects
        </a>
      </div>
