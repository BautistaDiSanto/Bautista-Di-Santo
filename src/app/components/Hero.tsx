  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-16 relative">
        {/* Decorative elements */}
        <div className="absolute -top-10 -left-10 w-20 h-20 bg-blue-100 dark:bg-blue-900/20 rounded-full blur-2xl opacity-50"></div>
        <div className="absolute -bottom-10 -right-10 w-20 h-20 bg-purple-100 dark:bg-purple-900/20 rounded-full blur-2xl opacity-50"></div>
        
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6 relative">
          Bautista <span className="text-blue-600 dark:text-blue-400">
            {name}
            <span className="animate-blink">|</span>
          </span>
          <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-24 h-1 bg-blue-600 dark:bg-blue-400 rounded-full"></div>
        </h1>
        <div className="space-y-6 relative">
          <div className={`transition-all duration-1000 ease-in-out ${showDescription ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
            ...
            <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 leading-relaxed mt-4">
      ...
      <div className="flex justify-center gap-4">
        ...
        <a
          href="#projects"
          className="px-6 py-3 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200"
        >
          View Projects
        </a>
      </div>
