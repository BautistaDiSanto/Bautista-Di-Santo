...
export default function TechCard({ name, logo }: TechCardProps) {
  ...
  return (
    <div
      className="flex-shrink-0 p-4 bg-white/20 dark:bg-white/10 rounded-xl shadow-md text-center hover:-translate-y-1 transition-all duration-200 hover:shadow-lg w-40 border border-white/20 dark:border-white/10 backdrop-blur-2xl relative overflow-hidden group"
    ...
    >
      ...
      <img
        ...
        height={80}
      />
      <span className="text-gray-900 dark:text-white font-medium block mt-2 relative z-10">
        {name}
      </span>
    </div>
  );
